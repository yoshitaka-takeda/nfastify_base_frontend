                    ...
                    <form class="" method="post" action="">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body px-3">
                                ...
                                <p class="align-left mb-0">
                                    Before continuing, we request further detail regarding you.
                                </p>
                                <p class="align-left mb-5">
                                    We have had our request mailed to <?=(isset($registrant_mail_address))?$registrant_mail_address:'your e-mail address' ?>. Check it up!
                                </p>
                                <p class="text-center text-muted mt-4 mb-0">Return to <a href="<?='/auth/login'?>"
